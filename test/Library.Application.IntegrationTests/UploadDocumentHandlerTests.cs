...
namespace Handlers.tests
{
    ...
    public sealed class UploadDocumentHandlerTests
    {
        ...
        public async Task Handler_shouldReturnSotredFileMeta()
        {
            ...
            var file = CreateFormFile("spec.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", new byte[] { 40, 50, 60 });
            ...
            Assert.AreEqual(file.Length, result.Length);
        }
