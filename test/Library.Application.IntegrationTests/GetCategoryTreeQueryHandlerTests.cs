...
namespace Handlers.tests
{
    ...
    public sealed class GetCategoryTreeQueryHandlerTests
    {
        ...
        public async Task Handler_withoutGuid_shouldReturnAllRootCategoryTrees()
        {
            ...
            var result = await mediator.Send(new GetCategoryTreeQuery(null), CancellationToken.None);
            ...
            Assert.AreEqual(0, root.ProductCount);
            ...
            Assert.AreEqual(0, extensionAndSlidingHandle.ProductCount);
            CollectionAssert.AreEquivalent(
                new List<Guid>
                {
        ...
        public async Task Handler_withGuid_shouldReturnRequestedCategoryTree()
        {
            ...
            var result = await mediator.Send(new GetCategoryTreeQuery(_categoryTestHelper.HandToolsCategoryId), CancellationToken.None);
            ...
            Assert.IsTrue(handTools.IsActive);
            Assert.AreEqual(0, handTools.ProductCount);
